...
var Caparazon = new THREE.SphereGeometry( 2, 8, 6, 0, Math.PI );

var PataFI = new THREE.CylinderGeometry(.6, .4, .8);
var PataFD = new THREE.CylinderGeometry(.6, .4, .8);
var PataTI = new THREE.CylinderGeometry(.6, .4, .8);
var PataTD = new THREE.CylinderGeometry(.6, .4, .8);
